...
namespace Lykke.Service.ConfirmationCodes.Core.Services
{
    ...
    {
        Task<string> RequestSmsCode(string partnerId, string clientId, string phoneNumber, bool isPriority = false, int expirationInterval = 0, int codeLength = 6);
        Task<string> RequestSmsCode(string partnerId, string phoneNumber, bool isPriority = false, int expirationInterval = 0, int codeLength = 6);
